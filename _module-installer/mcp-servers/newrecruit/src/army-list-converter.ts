 ...
 */
export function parseMarkdownArmyList(markdown: string, filePath?: string): ParsedArmyList {
 ...
 */
export function toPlainTextFormat(list: ParsedArmyList): string {
  const lines: string[] = [];
 ...
 */
export function toRosterFormat(list: ParsedArmyList): string {
  const lines: string[] = [];
  ...
  // Group by role
  const byRole: Record<string, ParsedUnit[]> = {};
  for (const unit of list.units) {
 ...
 */
export function parseNewRecruitList(text: string): Partial<ParsedArmyList> {
 ...
 */
export async function scanArmyLists(armyListsDir: string): Promise<ParsedArmyList[]> {
  const lists: ParsedArmyList[] = [];
 ...
 */
export function getListSummary(list: ParsedArmyList): string {
