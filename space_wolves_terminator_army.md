# Space Wolves Terminator Army - Tactical Reference

**Faction:** Space Wolves (Adeptus Astartes)
**Detachment:** Saga of the Beastslayer (Lethal Hits vs Characters/Monsters/Vehicles)
...
**Tactical Overview:**
- Single 10-man Terminator brick with Arjac
- No Deep Strike - all units start on board
- Castle center objective, wolves screen front
- Limited mobility and board control (15 models total)
- Incredibly durable but no redundancy

**How to Play:**
1. Deploy wolves 9" forward to screen charges
2. Castle on center with maximum fire lanes
3. Use Oath of Moment each turn on priority targets
4. Advance slowly (6" + Advance if needed)
5. Save CP for defensive Stratagems
...
| Wolf Guard Terminators | 10 | Primary Castle (Logan) | 340 |
| Wolf Guard Terminators | 10 | Secondary Castle (Arjac) | 340 |
| Wolf Guard Terminators | 10 | Backfield Holders | 340 |
| Blood Claws | 10 | Aggressive Melee | 140 |
| Grey Hunters | 10 | Mid-field Flex | 140 |
| Fenrisian Wolves | 10 | Screening / Fast Grab | 80 |
| **TOTAL** | **64** | | **1,940** |

**60pts remaining for wargear/additional units**

**Tactical Overview:**
- Maximum legal Terminators (30 models) under Rule of Three
- Two 10-man castle blocks led by Logan + Arjac
- Bjorn generates +1CP per turn
- Venerable Dread gives +1 to Advance/Charge within 6"
- Power armor support (Blood Claws + Grey Hunters) adds model count and melee pressure

**How to Play (Standard Deployment):**
1. **Deployment:** Logan's 10-man + Arjac's 10-man on center objectives. Third 10-man holds backfield. Blood Claws mid-field for counter-charge. Grey Hunters on flank. Wolves screen. Dreads positioned for auras.
2. **Turn 1:** Castle up, activate Oath of Moment, Bjorn provides fire support
3. **Turn 2:** Blood Claws charge or screen. Grey Hunters hold mid-field. Terminators advance with Dread aura.
4. **Turn 3+:** Grind opponents down through superior durability. Hold 3+ objectives.
...
1. **Reserve:** Place one 10-man Terminator squad in Deep Strike Reserve (recommend Arjac's squad for Hunter's Instincts vs backfield targets)
2. **Turn 1:** Deploy Logan's 10-man + third 10-man on center. Power armor holds flanks. Wolves screen.
3. **Turn 2:** Deep Strike Arjac's 10-man into enemy backfield near Venerable Dread for +1 to charge aura (8" charge needed instead of 9")
4. **Turn 3+:** Arjac's squad disrupts enemy backfield, forces split attention. Logan's castle grinds forward.
5. **Win Condition:** Two-front pressure overwhelms opponent's ability to respond

**CP Generation:** Bjorn gives +1CP per turn = sustainable Stratagem usage

---

## Full Model List - 2000pt Army

### Characters & Dreadnoughts (4 models)
- 1x Logan Grimnar (6W)
- 1x Arjac Rockfist (6W)
- 1x Bjorn the Fell-Handed (8W)
- 1x Venerable Dreadnought (8W)

### Terminators (30 models - all 3W each)
- 3x Models with twin lightning claws (Pack Leaders, one per squad) - 9W total
- 15x Storm shield + Thunder hammer - 45W total
- 6x Assault cannon + Powerfist - 18W total
- 6x Storm bolter + Powerfist - 18W total
...
**TOTAL: 64 models, 148 wounds** (28 Character/Dread + 90 Terminator + 20 Power Armor + 10 Wolves)
...
**Wargear:**
- The Axe Morkai (melee)
- Storm bolter

**Special Rules:**
- Epic Hero (only 1 per army)
- Can lead Wolf Guard Terminators
- Leader abilities boost attached unit

**Why Take Logan:** Chapter Master buffs, excellent melee with Axe Morkai, receives Blade of the Slayer enhancement for Precision (Character sniping)
...
**Wargear:**
- Foehammer (melee + throwable)
- Storm shield

**Special Rules:**
- Epic Hero (only 1 per army)
- Can lead Wolf Guard Terminators
- Champion of the Kingsguard ability

**Why Take Arjac:** T6 durability, excellent melee damage, receives Hunter's Instincts for reroll wounds vs Characters/Monsters/Vehicles

---

### Bjorn the Fell-Handed

**Stats:** M9" | T9 | Sv2+/5++ | W8 | Ld6+ | OC3 | 170pts

**Wargear:**
- Choose one: Assault cannon OR Helfrost cannon OR Multi-melta
- Heavy flamer
- Trueclaw (S12 AP-2 D3 Lethal Hits)

**Special Rules:**
- **Ancient Tactician:** Gain +1CP at start of each Command phase
- **Legendary Tenacity:** -1 to wound when S > T
- Feel No Pain 5+
- Deadly Demise 1

**Why Take Bjorn:** Free CP every turn, extremely durable, excellent melee and ranged damage, lore-accurate with Terminators

---

### Venerable Dreadnought

**Stats:** M8" | T9 | Sv2+/4++ | W8 | Ld6+ | OC3 | 140pts

**Wargear (Recommended):**
- Fenrisian greataxe (S14 AP-3 D6)
- Blizzard shield (4++ invuln)
- Heavy flamer

**Special Rules:**
- **Fervour of the Ancients (Aura):** +1 to Advance and Charge rolls for SPACE WOLVES within 6"
- Oath of Moment

**Why Take It:** +1 to charge aura is CRITICAL for advancing Terminators and making 9" Deep Strike charges easier. Blizzard shield gives 4++ durability. Fenrisian greataxe hits like a truck.
...
**Special Rules:**
- Fast movement (12")
- Cheap screening unit

**Why Take Them:** Fast objective grabbing, screen charges, tie up enemy melee threats, extremely cheap
...
- Full datasheet: Stats, abilities, wargear
...
- Epic Hero, Chapter Master
- Leader ability for Wolf Guard Terminators
- The Axe Morkai weapon profile

### Arjac Rockfist
**[Wahapedia - Arjac Rockfist](https://wahapedia.ru/wh40k10ed/factions/space-marines/Arjac-Rockfist)**
- Epic Hero, Logan's champion
- Leader ability for Wolf Guard Terminators
- Foehammer ranged + melee weapon

### Bjorn the Fell-Handed
**[Wahapedia - Bjorn](https://wahapedia.ru/wh40k10ed/factions/space-marines/Bjorn-The-Fell-Handed)**
- Ancient Tactician CP generation
- Legendary Tenacity and FNP 5+
- Weapon options and full stat line

### Venerable Dreadnought
**[Wahapedia - Venerable Dreadnought](https://wahapedia.ru/wh40k10ed/factions/space-marines/Venerable-Dreadnought)**
- Fervour of the Ancients aura (+1 Advance/Charge)
- Weapon options (Fenrisian greataxe, Blizzard shield)
- Space Marines datasheet (available to Space Wolves)

### Blood Claws
**[Wahapedia - Blood Claws](https://wahapedia.ru/wh40k10ed/factions/space-marines/Blood-Claws)**
- Berserk Charge ability
- Headstrong penalties
- Full melee and shooting profiles

### Grey Hunters
**[Wahapedia - Grey Hunters](https://wahapedia.ru/wh40k10ed/factions/space-marines/Grey-Hunters)**
- Versatile Space Wolves troops
- Balanced shooting and melee stats
- Full datasheet

### Fenrisian Wolves
**[Wahapedia - Fenrisian Wolves](https://wahapedia.ru/wh40k10ed/factions/space-marines/Fenrisian-Wolves)**
- Fast screening unit (12" move)
...
- Detachment ability: Lethal Hits vs Characters/Monsters/Vehicles
...
- Complete faction rules
- All detachments
- Stratagems
- **Oath of Moment:** Re-roll hit rolls vs selected enemy unit each Command phase
...
## 3D Printing Guide (2000pt Army)

### Terminator Arms (30 arm pairs needed)
...
**Total Models to Print/Acquire: 64**
...
*Rules Source: [Wahapedia](https://wahapedia.ru)*
